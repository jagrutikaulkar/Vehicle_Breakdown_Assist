...
if (mysqli_connect_error()) {
    ...
    if (isset($_POST['update_profile'])) {
        ...
        // Retrieve mechanic ID from session
        $mechid = $_SESSION['mech_id'];
        
        // Construct the SQL query
        $sql = "UPDATE mechanic_profile SET name='$update_name', email='$update_email', mobile_no='$update_mobile', username='$update_username', password='$update_password', image='$update_image' WHERE mech_id='$mechid'";
